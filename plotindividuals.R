...
pdf(paste0('Figures/allERProbot.pdf'), bg="transparent", height = 12, width = 10)
...
pdf(paste0('Figures/allMVPArobot.pdf'), bg="transparent", height = 12, width = 10)
...
includeds <- 1:28  #c(1,3,6,7,8,10,11,12,14:29)
...
pdf(paste0('Figures/allERPmask.pdf'), bg="transparent", height = 12, width = 10)
...
pdf(paste0('Figures/allMVPAmask.pdf'), bg="transparent", height = 12, width = 10)
